  ...
  <div id="result-search">
    <aside id="res-search">
      ...
      <ul id="res-lis">
        ...
        <a class="isSelected" href="./articles.php?query_search=<?php echo $query_search; ?>">
          Artigos
        </a>
      </ul>
    </aside>
    ...
    <main id="res-query">
      <ul id="res-app">
        <?php
        if ($query_search) {
          $sql = "SELECT id, title, tags FROM issue WHERE title LIKE '%$query_search%'";
            ...
            while ($set = mysqli_fetch_array($sql_result)) {
              ...
              echo
                ...
                <li id='res-users-app'>
                  ...
                  <a id='goAhead' href='/web/public/learning.php?issue_id=$id'>
                    Ver completo
                  </a>
                </li>
              ";
