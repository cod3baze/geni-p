...
<body>
  ...
  <div id="result-search">
    <aside id="res-search">
      <h4>Tópicos</h4>
      <ul id="res-lis">
        <a href="./users.php?query_search=<?php echo $query_search; ?>">
          Usuários
        </a>
        <a class="isSelected" href="./lists.php?query_search=<?php echo $query_search; ?>">
          Listas
        </a>
    ...
    <main id="res-query">
      <ul id="res-app">
        <?php
        if ($query_search) {
          $sql = "SELECT  lst.id as id, lst.name as name, usr.name as uname FROM playlist AS lst
          JOIN users AS usr on lst.owner = usr.id
          WHERE lst.name LIKE '%$query_search%'";
            ...
            while ($set = mysqli_fetch_array($sql_result)) {
              ...
              echo
                ...
                <li id='res-users-app'>
                  ...
                  <a id='goAhead' href='/web/public/playlist.php?list_id=$id'>
                    Começar
                  </a>
                </li>
              ";
